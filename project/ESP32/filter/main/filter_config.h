...
typedef struct
{
    ...
    fts_timer_state_e timer_state;

    volatile bool sim_mode_pending;
    volatile fgen_sim_mode_e next_sim_mode;
    fgen_sim_mode_e active_sim_mode;

    volatile bool sim_amp_pending;
    volatile int16_t next_sim_amp;
    int16_t active_sim_amp;
...
extern const void *g_coeff_override; // set by coeff loader, NULL = use bank
...
static inline const void *filter_get_coeff(filter_type_e t)
{
    if (g_coeff_override)
    {
        return g_coeff_override; /* one-shot use after load */
    }
    switch (t)
    {
    case _IIR_FLOAT:
        return &coeff_iir_float;
    case _IIR_INT:
        return &coeff_iir_int;
    case _FIR_FLOAT:
        return &coeff_fir_float;
    case _FIR_INT:
        return &coeff_fir_int;
    case _SOS_FLOAT:
        return &coeff_sos_float;
    case _SOS_INT:
        return &coeff_sos_int;
    case _LTC_FLOAT:
        return &coeff_ltc_float;
    case _LTC_INT:
        return &coeff_ltc_int;
    default:
        return &coeff_iir_float;
    }
}

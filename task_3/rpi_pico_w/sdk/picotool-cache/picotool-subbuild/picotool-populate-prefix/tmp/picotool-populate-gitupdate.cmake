...
execute_process(
  COMMAND "C:/Git/cmd/git.exe" --git-dir=.git show-ref "2.2.0"
  WORKING_DIRECTORY "D:/RWU/Embedded-Project/task_3/rpi_pico_w/sdk/picotool-cache/picotool-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/RWU/Embedded-Project/task_3/rpi_pico_w/sdk/picotool-cache/picotool-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/RWU/Embedded-Project/task_3/rpi_pico_w/sdk/picotool-cache/picotool-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
